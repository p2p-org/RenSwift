...
Pod::Spec.new do |s|
  s.name             = 'RenSwift'
  s.version          = '0.1.0'
  s.summary          = 'A short description of RenSwift.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Chung Tran/RenSwift'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Chung Tran' => 'bigearsenal@gmail.com' }
  s.source           = { :git => 'https://github.com/Chung Tran/RenSwift.git', :tag => s.version.to_s }
